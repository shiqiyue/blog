package cn.wuwenyao.blog.site.interceptor;
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
		...
		if (handler instanceof HandlerMethod) {
			if (isEnable()) {
				...
				sb.append("class:").append(method.getBean().getClass().getSimpleName()).append("||method:")
						.append(method.getMethod().getName()).append("||thread id:").append(threadId)
						.append("||start----");
	...
	public void afterCompletion(HttpServletRequest request, HttpServletResponse response, Object handler, Exception ex)
		...
		if (handler instanceof HandlerMethod) {
			if (isEnable()) {
				...
				sb.append("class:").append(method.getBean().getClass().getSimpleName()).append("||method:")
						.append(method.getMethod().getName()).append("||thread id:").append(threadId)
						.append("||use time:").append(System.currentTimeMillis() - startTime.get()).append("ms");
				logger.info(sb.toString());
			}
		}
	}
